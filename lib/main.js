...
var ZeroBus = /** @class */ (function () {
    ...
    ZeroBus.prototype.getPeerIps = function (online) {
        ...
        var peerIps = lodash_1.values(this.zyreInstance._zyrePeers._peers).filter(function (p) { return p._connected; }).map(function (p) { return p._endpoint.split('/')[2].split(':')[0]; });
